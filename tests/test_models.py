...
class TestProductModel(unittest.TestCase):
    ...
    def test_find_by_price(self):
        ...
        product = ProductFactory()
        product.create()
        products = Product.find_by_price(price=product.price)
        self.assertEqual(products.count(), 1)
        self.assertAlmostEqual(products[0].price, product.price)
        products = Product.find_by_price(price=str(product.price))
        self.assertEqual(products.count(), 1)
        self.assertAlmostEqual(products[0].price, product.price)
